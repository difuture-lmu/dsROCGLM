...
## Create dummy model:
local_data1 = read.csv(here::here("inst/extdata/ds-test-cnsim1.csv"))
local_data2 = read.csv(here::here("inst/extdata/ds-test-cnsim2.csv"))
...
pROC::auc(local_data$DIS_DIAB, p)
